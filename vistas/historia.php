...
<section>
      ...
      <p>Título: Profesor de Historia</p>
      <h5>
		   		La carrera tiene como función formar docentes en el campo específico de la Historia con sólida base científica para desempeñarse en organizaciones formales y no formales. Formar docentes capacitados para la interpretación y transmisión educativa de la Historia con miradas interrogadoras de las dimensiones sociales, culturales, económicas y políticas, articulando pasado, presente y futuro. Desarrollar el dominio de marcos conceptuales, interpretativos y valorativos para el análisis y comprensión de las realidades socio histórica. Propender a la investigación como núcleo fundamental en la formación docente. Estimular activamente el desarrollo social desde una perspectiva integrada, que valore la diversidad, la libertad y el bienestar desde una perspectiva democrática. Fomentar la colaboración desde el campo de la Historia con el conjunto de acciones sociales en curso y futuras en torno a la recuperación de la verdad, la memoria y los reclamos de las comunidades indígenas y populares. Propiciar la utilización crítica de las nuevas tecnologías de la información y la comunicación (TIC) como recurso didáctico.
			</h5>

      <legend class="fontform">Perfil del Título</legend>
      <h5>
		 			El egresado podrá desarrollar labores docentes, pedagógicas y administrativas para apoyar la planificación, conducción y evaluación de los procesos de enseñanza-aprendizaje en el área de Historia y Ciencias Sociales afines en el ámbito de la enseñanza secundaria. Ejercer la docencia en el área de la Historia desarrollando una capacidad crítica para el tratamiento de los diferentes problemas históricos e historiográficos, en contextos sociales y culturales diversos. Participar en programas y proyectos interdisciplinarios de educación. Desarrollar investigaciones conducentes a problematizar el conocimiento disciplinar y pedagógico, para perfeccionar el diseño y ejecución de situaciones de enseñanza y aprendizaje de la Historia y Ciencias Sociales afines. Formar recursos humanos para el ejercicio de la docencia en el campo de la Historia.
		  </h5>

      <iframe  src="../PDFs/Historia.pdf" width="100%" height="600px"></iframe>
		</div>
</section>
