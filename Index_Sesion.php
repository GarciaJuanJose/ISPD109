    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav ml-auto text-center">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="<?php echo URL_PROJECT ?>/Pre-Inscripcion.php" role="button" aria-haspopup="true" aria-expanded="false">Pre-Inscripción</a>
          </li>
          <li class="nav-item active">
  ...
  <!-- <footer class="site-footer seccion">
    <div class="contenedor contenedor-footer">
      <nav class="navegacion">
        <?php
        if (!empty($_SESSION['numdni'])) {
          echo "<a href='#'>" . $_SESSION['numdni'] . "</a>";
        } else {
          echo "<a href='Login2.php'>Iniciar sesión</a>";
        } ?>
